...
TimerMs sekd(1000, 0, 0);  // таймер 1 секунда для вывода на дисплей и периодических функций
...
/* service[15];          // основные параметры зарядника
  ...
  2  INAVOLTKOOF 125       // коэффициент напряжения INA226
